...
RUN apt-get update && \
    apt-get install -y curl cron bzip2 perl-modules lsof libc6-i386 lib32gcc1 sudo nano

RUN curl -sL "https://raw.githubusercontent.com/arkmanager/ark-server-tools/v1.6.54/netinstall.sh" | bash -s steam && \
